...
public class CellCluster {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Filter towers based on network ID
        ...
        // Get a dataset of only LTE towers
        ...
        // Parse how many clusters are needed
        long clusterCount = params.has("k") ? Long.parseLong(params.get("k")) : lteTowers.count();

        // Convert LTE CellTowers into the Centroid format
        ...
        // Convert remaining towers into Points
